...
@Component({
    ...
    imports: [ConfirmationModalComponent, SignpostComponent, BadgeComponent, SwitchComponent, 
      ModalComponent, 
      AccordionComponent, AccordionPanelComponent, AccordionPanelHeaderComponent, CardSectionBasicComponent, SideMenuComponent, SideMenuEntryComponent, SideMenuSectionComponent,
      MenuItemComponent, MenuBarComponent, TabComponent, TabsComponent, GridComponent, ValueTileComponent, SwitchButtonComponent, SwitchButtonOptionComponent,
  ...
  export class UiLibPageComponent  {
    ...
    updateSideMenuSelection(event: any) {
      console.log('Side Menu Selection Changed:', event);
    }

    sideMenuSelectedValue = signal<string | number | boolean>('list');
